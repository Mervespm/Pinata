...
PINATA_PATCH_falcon_decode_start_callback_t PINATA_PATCH_falcon_decode_start_callback = NULL;
PINATA_PATCH_falcon_decode_finish_callback_t PINATA_PATCH_falcon_decode_finish_callback = NULL;
...
PINATA_PATCH_falcon_decode_start_callback_t PINATA_PATCH_falcon_set_decode_start_callback(PINATA_PATCH_falcon_decode_start_callback_t f) {
	PINATA_PATCH_falcon_decode_start_callback_t old = PINATA_PATCH_falcon_decode_start_callback;
	PINATA_PATCH_falcon_decode_start_callback = f;
	return old;
}
...
PINATA_PATCH_falcon_decode_finish_callback_t PINATA_PATCH_falcon_set_decode_finish_callback(PINATA_PATCH_falcon_decode_finish_callback_t f) {
	PINATA_PATCH_falcon_decode_finish_callback_t old = PINATA_PATCH_falcon_decode_finish_callback;
	PINATA_PATCH_falcon_decode_finish_callback = f;
	return old;
}
